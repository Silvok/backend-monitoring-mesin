...
<aside class="hidden md:flex flex-col w-72 bg-white border-r border-gray-100 h-screen fixed left-0 top-20">
    ...
    <div class="flex-1 overflow-y-auto px-3 py-4">
        <nav class="space-y-1">
            ...
            <!-- Dashboard -->
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-lg text-gray-700 font-medium transition duration-200
               @if(request()->routeIs('dashboard'))
                   text-gray-900
               @else
                   hover:bg-gray-50 text-gray-600
               @endif" @if(request()->routeIs('dashboard'))
            ...
            <a href="{{ route('real-time-sensor') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-lg font-medium transition duration-200
               @if(request()->routeIs('real-time-sensor'))
                   text-gray-900
               @else
                   text-gray-600 hover:bg-gray-50 hover:text-gray-900
               @endif" @if(request()->routeIs('real-time-sensor'))
                style="background: linear-gradient(to right, rgba(49, 105, 78, 0.35), rgba(39, 86, 64, 0.35)); color: #163527;"
            @endif>
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Monitoring Mesin -->
            <a href="{{ route('monitoring-mesin') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-lg font-medium transition duration-200
               @if(request()->routeIs('monitoring-mesin'))
                   text-gray-900
               @else
                   text-gray-600 hover:bg-gray-50 hover:text-gray-900
               @endif" @if(request()->routeIs('monitoring-mesin'))
                style="background: linear-gradient(to right, rgba(49, 105, 78, 0.35), rgba(39, 86, 64, 0.35)); color: #163527;"
            @endif>
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span class="text-sm">Monitoring Mesin</span>
            </a>

            <!-- Analisis -->
            <a href="{{ route('analisis') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-lg font-medium transition duration-200
               @if(request()->routeIs('analisis'))
                   text-gray-900
               @else
                   text-gray-600 hover:bg-gray-50 hover:text-gray-900
               @endif" @if(request()->routeIs('analisis'))
                style="background: linear-gradient(to right, rgba(49, 105, 78, 0.35), rgba(39, 86, 64, 0.35)); color: #163527;"
            @endif>
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="#"
                ...
                <div class="relative">
                    <svg class="w-5 h-5 flex-shrink-0 group-hover:text-red-600 transition" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 8v4m0 4v2m0-10a4 4 0 110 8 4 4 0 010-8z" />
                    </svg>
            ...
            <a href="#"
                class="flex items-center space-x-3 px-4 py-2.5 rounded-lg text-gray-600 font-medium hover:bg-gray-50 hover:text-gray-900 transition duration-200 group">
                <div class="relative">
                    <svg class="w-5 h-5 flex-shrink-0 group-hover:text-yellow-600 transition" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
